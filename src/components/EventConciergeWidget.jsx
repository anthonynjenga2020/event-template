  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex items-center gap-2 sm:gap-3">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="bg-[#25D366] text-white shadow-2xl p-3 sm:px-4 sm:py-3.5 rounded-full flex items-center gap-2 text-xs font-bold uppercase tracking-wider border border-emerald-400/30 hover:bg-[#20ba5a] transition-all"
      ...
      <div className="relative">
        ...
        >
          ...
          <span>{isOpen ? 'Close' : '🎉 Concierge'}</span>
        </motion.button>
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute bottom-14 sm:bottom-16 right-0 w-[calc(100vw-2rem)] sm:w-96 max-w-sm max-h-[85vh] overflow-y-auto bg-[#141414] border border-[#222222] shadow-2xl mb-2 rounded-2xl"
              style={{ backgroundColor: 'var(--surface, #141414)', borderColor: 'var(--border, #222222)' }}
            >
              {/* Header */}
              <div 
